...
<section class="flex flex-col items-center justify-center gap-4 p-4 py-0">
	<div
	...
	<div class="mt-8 flex flex-col gap-4 lg:px-64">
		...
		<p class="rounded-3xl border-2 border-white/20 bg-dark-5 p-4 text-lg md:rounded-xl lg:text-xl">
			...
			is to be successful. I live in Turkiye 🇹🇷. I studied English in the English project class for
			4 years straight. I don't believe coding requires math because solving a math problem is a
