...
<section class="flex flex-col items-center justify-center gap-4 p-16 py-0">
	...
	<div class="mt-8 flex flex-col gap-4 lg:px-64">
		<p class="text-md mb-2 text-center md:text-xl">
			<span class="rounded-2xl border-2 border-white/20 bg-dark-5 p-3"
				>I'm Buğra! I'm <span class="font-bold text-primary">{data.age.years}</span> years old.</span
			>
		</p>
		<p class="rounded-3xl border-2 border-white/20 bg-dark-5 p-4 text-lg md:rounded-xl lg:text-xl">
			Also known as rabug, I started coding at age 9 with C#. Still, I love programming, and my goal
			is to be successful. I live in Turkey 🇹🇷. I studied English in the English project class for 4
			years straight. I don't believe coding requires math because solving a math problem is a
			computer job, and I find this funny. I also make animations, 3D models, games, and design.
			Anyway, if you want to contact me or something, you can look at the <a href="/contact"
				>contact</a
			> page.
		</p>
	</div>
